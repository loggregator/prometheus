...
import "github.com/loggregator/prometheus/pkg/textparse"
...
//
//     go-fuzz-build -func FuzzParseMetric -o FuzzParseMetric.zip github.com/loggregator/prometheus/promql
//
