...
See [issue #3060](https://github.com/loggregator/prometheus/issues/3060) for more
details.
...
as a non-root user](https://github.com/loggregator/prometheus/pull/2859). If you
